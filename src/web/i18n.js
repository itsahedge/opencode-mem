const translations = {
  en: {
    ...
    "opt-backfill-all": "All Sessions",
    "opt-backfill-days": "Last N Days",
    "opt-backfill-date-range": "Date Range",
    "opt-backfill-search": "Search",
    "opt-backfill-session-ids": "Session IDs",
    "label-backfill-mode": "Mode:",
    "label-backfill-days": "Days:",
    "label-backfill-from": "From:",
    "label-backfill-to": "To:",
    "label-backfill-search": "Search Term:",
    "label-backfill-session-ids": "Session IDs:",
    "label-backfill-batch-size": "Batch Size:",
    "label-backfill-max-sessions": "Max Sessions:",
    "placeholder-backfill-search": "Enter search term...",
    "placeholder-backfill-session-ids": "Enter session IDs (one per line)...",
    "placeholder-backfill-max-sessions": "Unlimited",
    "help-backfill-batch-size": "Number of sessions to process in each batch",
    "help-backfill-max-sessions": "Leave empty for no limit",
    "help-backfill-session-ids": "Enter one session ID per line",
    "btn-run-backfill": "Run Backfill",
    "status-backfill-init": "Initializing backfill...",
    "modal-edit-title": "Edit Memory",
    "modal-migration-title": "Memory Tagging Migration",
    "modal-changelog-title": "Profile Version History",
    "modal-backfill-title": "Backfill Historical Sessions",
    "modal-backfill-progress-title": "Backfill in Progress",
    "btn-cancel": "Cancel",
